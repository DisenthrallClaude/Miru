...
1. 到 [Releases](https://github.com/DisenthrallClaude/Miru/releases/latest) 下载 APK（直链：[Miru-1.6.5-android-arm64-release.apk](https://github.com/DisenthrallClaude/Miru/releases/download/v1.6.5/Miru-1.6.5-android-arm64-release.apk)），每个版本附 `.sha1` 校验文件
2. 安装（首次需允许「安装未知来源应用」）
3. 首启跟着引导走完，规则会自动装好
