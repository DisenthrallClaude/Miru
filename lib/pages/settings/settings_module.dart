...
import 'package:miru/pages/about/about_module.dart';
import 'package:miru/pages/bangumi/bangumi_module.dart';
import 'package:miru/pages/download/download_page_module.dart';
import 'package:miru/pages/history/history_module.dart';
import 'package:miru/pages/plugin_editor/plugin_module.dart';
import 'package:miru/pages/settings/danmaku/danmaku_module.dart';
...
import 'package:miru/pages/settings/super_resolution_settings.dart';
import 'package:miru/pages/settings/theme_settings_page.dart';
import 'package:miru/pages/webdav_editor/webdav_module.dart';
